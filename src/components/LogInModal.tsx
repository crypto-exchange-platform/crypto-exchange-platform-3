...
export const LoginModal: FC<LoginModalProps> = ({ onClose }) => {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      <div className="bg-yellow-300 text-black w-full max-w-md p-6 rounded-md shadow-lg relative">
        ...
        <form className="space-y-4">
          ...
          <input
            ...
            className="w-full border p-2 rounded"
          />
          <button type="submit" className="w-full bg-blue-600 text-white py-2 rounded hover:bg-gray-900">
            Log In
          </button>
        </form>
      </div>
